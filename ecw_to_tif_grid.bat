...
set INPUT="D:\Documents\cyber\projects\vaayu\code\data\Gujarat\ortho_lalpur(511638)_3857.ecw"

rem Set the desired output directory (make sure to change this path if needed)
set OUT_DIR="D:\Documents\cyber\projects\vaayu\code\data\Gujarat\tiles_output"

rem Set the tile dimensions (in pixels)
set TILE_WIDTH=1000
set TILE_HEIGHT=1000
